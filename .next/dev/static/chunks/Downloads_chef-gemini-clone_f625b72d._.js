...
function VoiceControlButton({ isListening, isSupported, lastCommand, error, onStartListening, onStopListening, onShowHelp }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$chef$2d$gemini$2d$clone$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed bottom-24 left-1/2 -translate-x-1/2 w-full max-w-4xl px-4 sm:px-6 z-50 pointer-events-none",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$chef$2d$gemini$2d$clone$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$chef$2d$gemini$2d$clone$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: handleClick,
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$chef$2d$gemini$2d$clone$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative p-5 rounded-full shadow-2xl transition-all transform hover:scale-105 active:scale-95", isListening ? "bg-red-500 hover:bg-red-600 text-white animate-pulse" : "bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white"),
    ...
    const processCommand = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$chef$2d$gemini$2d$clone$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceControl.useCallback[processCommand]": (transcript)=>{
            ...
            if (transcript.includes('next') || transcript.includes('forward')) {
                ...
                console.log('Executing: Repeat/Read step');
                readCurrentStep();
                ...
                if (match) {
                    ...
                    if (stepNum > 0 && stepNum <= (opts.totalSteps || 0)) {
                        console.log('Executing: Go to step', stepNum);
                ...
                console.log('Executing: Show directions');
                ...
                console.log('Executing: Read current step');
                readCurrentStep();
                    ...
                    "useVoiceControl.useEffect": (event)=>{
                        ...
                        setState({
                            "useVoiceControl.useEffect": (prev)=>({
                                    ...prev,
                                    isListening: false,
                                    error: event.error === 'no-speech' ? 'No speech detected' : 'Error recognizing speech'
                                })
                        }["useVoiceControl.useEffect"]);
                    }
                })["useVoiceControl.useEffect"];
...
_s(useVoiceControl, "8WbIAivAk4tYXf58GVr152t0GW8=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(CookingInterface, "cd9wYJPJCFfBR+watMxiqJ3HNi8=", false, function() {
    return [
...
//# sourceMappingURL=Downloads_chef-gemini-clone_f625b72d._.js.map